...
function registerProgressHandlers(
  ...
  const disposable = client.onProgress(
    NgccProgressType,
    NgccProgressToken,
    async (params: NgccProgress) => {
...
function getServerOptions(
  ...
  const prodBundle = ctx.asAbsolutePath(
    path.join("node_modules", "@angular", "language-server")
  );
  const devBundle = ctx.asAbsolutePath(
    path.join("node_modules", "@angular", "language-server")
  );
